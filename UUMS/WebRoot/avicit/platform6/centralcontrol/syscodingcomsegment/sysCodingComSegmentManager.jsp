...
function addComSegment(){
	var usd = new CommonDialog("addComSegmentDialog","520","200","avicit/platform6/centralcontrol/syscodingcomsegment/sysCodingComSegmentAdd.jsp","添加通用码段",true);
	var buttons = [{
		text:'保存',
		id : 'formSubimt',
		iconCls : '',
...
function updateComSegment(){
	...
	var usd = new CommonDialog("updateComSegmentDialog","520","200","platform/cc/sysCodingComSegment/toUpdateComSegmentJsp.jsp?id="+id,"编辑通用码段",true);
	var buttons = [{
		text:'保存',
		id : 'formSubimt',
		iconCls : '',
