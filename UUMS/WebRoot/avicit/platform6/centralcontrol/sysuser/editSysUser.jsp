...
<jsp:include page="/avicit/platform6/centralcontrol/sysuser/edithead.jsp"></jsp:include>
				...
				<form id="formEditBaseInfo" method="post">
						...
						<tr>
							...
							<td align="right" width="170">
								<span style="width: 150px; height: 20px;">
									<select class="easyui-combobox" data-options="{required:true,panelHeight:'auto',editable:false,width:'151'}" name="secretLevel" id="secretLevel" <c:if test="${isNotSaveManager}">readonly='readonly'</c:if>>
					...
					<table>
						...
						<tr>
							...
							<td align="right" width="168">
								...
								<span class="requiedbox" style="width: 168px;_width:170px; height: 23px;">
									...
									<span class="selectbox" style="width: 151px;_width:151px; height: 20px;">
										<input type="text" id="ruleName" class="selectbox-text easyui-validatebox" data-options="required:true" name="ruleName" readonly="readonly" style="width: 
										<c:choose>
										...
										height: 20px; line-height: 20px;" value="${sysUser.ruleName}"/>
										<span>
											<span class="selectbox-button" onclick="mySelectRole();" style="height: 20px;<c:if test="${isNotSaveManager}">display:none</c:if>"></span>
										</span>
									</span>
								</span>	
							</td>
						...
						<tr>
							...
							<td align="right" width="168">
								  	<input title="办公电话" class="inputbox" type="text" name="officeTel" id="officeTel" value="${sysUser.officeTel}"/>
							</td>
							<td width="70" align="right">
								<label>传真</label>
							</td>
							<td>
							  	<input title="传真" class="inputbox" type="text" name="fax" id="fax" value="${sysUser.fax}"/>
							</td>
						</tr>
						<tr>
							<td width="80" align="right">
						...
						<tr>
							...
							<td>
								<input value="${sysUser.homeTel}" class="inputbox" type="text" name="homeTel" id="homeTel"/>
							</td>
						</tr>
						<tr>
							<td width="80" align="right">
