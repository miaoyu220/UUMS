					...
					<table>
						...
						<tr>
							...
							<td align="right" width="170"><input type="hidden"
								name="deptId" id="deptId" value="${deptId}" /> <span
								class="requiedbox"
								style="width: 170px;_width:170px; height: 23px;"> <span>
									...
									style="width: 151px;_width:151px; height: 20px;"> <input
										...
										data-options="required:true" name="deptName"
										readonly="readonly"
										style="width: 128px; height: 20px; line-height: 20px;"
										value="${deptName}" /> <span> <span
											class="selectbox-button" onclick="mySelectDept();"
