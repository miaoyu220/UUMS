...
(function($, undefined){
    $.widget("ui.portlet", {
                ...
                var title = $('<div/>', {
                    ...
                    html: function() {
                        if($.isFunction(pattrs.title)) {
                            return "<a href='javascript:void(0)' onclick=\"parent.addTab('"+pattrs.title+"','"+pattrs.subUrl+"')\">"+pattrs.title+"</a>";
                        }
                        if(pattrs.icon) {
                            return "<span class='" + pattrs.icon + "'></span>" + "<a href='#' onclick=\"event.preventDefault();parent.addTab('"+pattrs.title+"','"+pattrs.subUrl+"')\">"+pattrs.title+"</a>";
                        } else {
                            return "<a href='javascript:void(0)' onclick=\"parent.addTab('"+pattrs.title+"','"+pattrs.subUrl+"')\">"+pattrs.title+"</a>";
                        }
                    }
        ...
        _sortable: function(value) {
            ...
            $(".ui-portlet-content", this.element).css('height','');
        },
