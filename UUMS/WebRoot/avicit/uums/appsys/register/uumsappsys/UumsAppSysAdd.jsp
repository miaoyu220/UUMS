...
<!-- ControllerPath = "uums/appsys/register/uumsappsys/UumsAppSysController/operation/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
			...
			<table width="100%" style="padding-top: 10px;">
				<tr>
					...
					<td><input title="应用系统编码" class="easyui-validatebox"
						...
						style="width: 180px;" type="text" name="appCode" id="appCode" /></td>
					...
					<td><input title="应用系统名称" class="easyui-validatebox"
						...
						style="width: 180px;" type="text" name="appName" id="appName" /></td>
				</tr>
				<tr>
					...
					<td><input title="{param.field.comment}" class="inputbox"
						...
						<div class="">
							<input class="easyui-validatebox" name="securitAdminAlias"
								id="securitAdminAlias" readOnly="readOnly" style="width: 179px;"></input>
						</div></td>
				...
				<tr>
					...
					<td>
						<%-- <pt6:syslookup name="delAuditFlag"
				...
				<tr>
					...
					<td colspan="3"><textarea title="应用系统简介" class="inputbox easyui-validatebox scrollbar"
						...
						type="text" name="appDescribe" id="appDescribe" ></textarea></td>
				</tr>
			</table>
		</form>
	...
	<script type="text/javascript">
		...
		function closeForm() {
			parent.uumsAppSys.closeDialog("#insert");
		}
		function saveForm() {
			if ($('#form').form('validate') == false) {
				return;
			}
			parent.uumsAppSys.save(serializeObject($('#form')), "#insert");
		}
