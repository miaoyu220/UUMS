...
function openCodingSystem(){
	parent.addTab?parent.addTab('编码体系管理','avicit/platform6/centralcontrol/syscodingsystem/sysCodingSystemManager.jsp','static/css/platform/themes/default/index/style/images/folder_lightbulb.png','sysmgr','0px 0px'):window.open('avicit/platform6/centralcontrol/syscodingsystem/sysCodingSystemManager.jsp', '_self');
}
function openCodingSelect(){
	parent.addTab?parent.addTab('编码使用查询','avicit/platform6/centralcontrol/syscodingselect/sysCodingSelectManager.jsp','static/css/platform/themes/default/index/style/images/folder_lightbulb.png','search','0px 0px'):window.open('avicit/platform6/centralcontrol/syscodingselect/sysCodingSelectManager.jsp', '_self');
}
 ...
 */
function addRule(){
	var usd = new CommonDialog("addCodingRuleDialog","800","400","avicit/platform6/centralcontrol/syscodingrule/sysCodingRuleAdd.jsp?appId="+$appId,"添加代码规则",true);
	var buttons = [{
		text:'保存',
		id : 'formSubimt',
		iconCls : '',
...
function updateRule(){
	...
	var usd = new CommonDialog("updateCodingRuleDialog","800","400","platform/cc/sysCodingRule/toUpdateRuleJsp.jsp?id="+id,"编辑代码规则",true);
	var buttons = [{
		text:'保存',
		id : 'formSubimt',
		iconCls : '',
...
function copyRule(){
	...
	var usd = new CommonDialog("copyCodingRuleDialog","800","400","platform/cc/sysCodingRule/toUpdateRuleJsp.jsp?id="+ id +"&isCopy=true","复制代码规则",true);
	var buttons = [{
		text:'保存',
		id : 'formSubimt',
		iconCls : '',
 ...
 */
 function formatterCodingName(value,row,index){
	 return '<img  alt="" style="cursor: pointer;width:30px;height:30px;" src="avicit/platform6/centralcontrol/syscodingrule/images/'+row.signImage+'.gif" >    '+value;
}
