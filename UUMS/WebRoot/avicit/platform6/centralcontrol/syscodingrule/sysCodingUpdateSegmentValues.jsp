...
function exportSegmentValue(segmentIndex){
	var baseId = $('#baseId').val();
	$('#loadFileIframe').attr("src", getPath() +'/platform/cc/sysCodingExcel/exportSegmentValueData?baseId=' + baseId + '&segmentIndex=' + segmentIndex);
}
...
function downloadTemplate(segmentIndex){
	var baseId = $('#baseId').val();
	$('#loadFileIframe').attr("src", getPath() +'/platform/cc/sysCodingExcel/downloadTemplate?baseId=' + baseId + '&segmentIndex=' + segmentIndex);
}
</script>
</head>
