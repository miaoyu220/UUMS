				...
				<table width="660px" border="0" align="center">
					...
					<tr height="30px">
						...
						<td>
							<input id="criterionId" name="criterionId" style="width:222px;" class="easyui-combotree" 
								data-options="
									url:'platform/cc/sysCodingSystem/getCodingSystemTreeAllValidData.json?appId=${ruleBase.sysApplicationId}',
									required:true,
									lines:true,
					...
					<tr height="150px">
						<td colspan="4">
							<table width="660px" border="0" align="center">
								<tr height="50px">
									<td width="66px" align="center"><img id="rulebase_01" name="selectImage" alt="" style="cursor: pointer;" src="avicit/platform6/centralcontrol/syscodingrule/images/rulebase_01.gif" onclick="selectSignImage(this)"></td>
									<td width="66px" align="center"><img id="rulebase_02" name="selectImage" alt="" style="cursor: pointer;" src="avicit/platform6/centralcontrol/syscodingrule/images/rulebase_02.gif" onclick="selectSignImage(this)"></td>
									<td width="66px" align="center"><img id="rulebase_03" name="selectImage" alt="" style="cursor: pointer;" src="avicit/platform6/centralcontrol/syscodingrule/images/rulebase_03.gif" onclick="selectSignImage(this)"></td>
									<td width="66px" align="center"><img id="rulebase_04" name="selectImage" alt="" style="cursor: pointer;" src="avicit/platform6/centralcontrol/syscodingrule/images/rulebase_04.gif" onclick="selectSignImage(this)"></td>
									<td width="66px" align="center"><img id="rulebase_05" name="selectImage" alt="" style="cursor: pointer;" src="avicit/platform6/centralcontrol/syscodingrule/images/rulebase_05.gif" onclick="selectSignImage(this)"></td>
									<td width="66px" align="center"><img id="rulebase_06" name="selectImage" alt="" style="cursor: pointer;" src="avicit/platform6/centralcontrol/syscodingrule/images/rulebase_06.gif" onclick="selectSignImage(this)"></td>
									<td width="66px" align="center"><img id="rulebase_07" name="selectImage" alt="" style="cursor: pointer;" src="avicit/platform6/centralcontrol/syscodingrule/images/rulebase_07.gif" onclick="selectSignImage(this)"></td>
									<td width="66px" align="center"><img id="rulebase_08" name="selectImage" alt="" style="cursor: pointer;" src="avicit/platform6/centralcontrol/syscodingrule/images/rulebase_08.gif" onclick="selectSignImage(this)"></td>
									<td width="66px" align="center"><img id="rulebase_09" name="selectImage" alt="" style="cursor: pointer;" src="avicit/platform6/centralcontrol/syscodingrule/images/rulebase_09.gif" onclick="selectSignImage(this)"></td>
									<td width="66px" align="center"><img id="rulebase_10" name="selectImage" alt="" style="cursor: pointer;" src="avicit/platform6/centralcontrol/syscodingrule/images/rulebase_10.gif" onclick="selectSignImage(this)"></td>
								</tr>
								<tr height="50px">
									<td width="66px" align="center"><img id="rulebase_11" name="selectImage" alt="" style="cursor: pointer;" src="avicit/platform6/centralcontrol/syscodingrule/images/rulebase_11.gif" onclick="selectSignImage(this)"></td>
									<td width="66px" align="center"><img id="rulebase_12" name="selectImage" alt="" style="cursor: pointer;" src="avicit/platform6/centralcontrol/syscodingrule/images/rulebase_12.gif" onclick="selectSignImage(this)"></td>
									<td width="66px" align="center"><img id="rulebase_13" name="selectImage" alt="" style="cursor: pointer;" src="avicit/platform6/centralcontrol/syscodingrule/images/rulebase_13.gif" onclick="selectSignImage(this)"></td>
									<td width="66px" align="center"><img id="rulebase_14" name="selectImage" alt="" style="cursor: pointer;" src="avicit/platform6/centralcontrol/syscodingrule/images/rulebase_14.gif" onclick="selectSignImage(this)"></td>
									<td width="66px" align="center"><img id="rulebase_15" name="selectImage" alt="" style="cursor: pointer;" src="avicit/platform6/centralcontrol/syscodingrule/images/rulebase_15.gif" onclick="selectSignImage(this)"></td>
									<td width="66px" align="center"><img id="rulebase_16" name="selectImage" alt="" style="cursor: pointer;" src="avicit/platform6/centralcontrol/syscodingrule/images/rulebase_16.gif" onclick="selectSignImage(this)"></td>
									<td width="66px" align="center"><img id="rulebase_17" name="selectImage" alt="" style="cursor: pointer;" src="avicit/platform6/centralcontrol/syscodingrule/images/rulebase_17.gif" onclick="selectSignImage(this)"></td>
									<td width="66px" align="center"><img id="rulebase_18" name="selectImage" alt="" style="cursor: pointer;" src="avicit/platform6/centralcontrol/syscodingrule/images/rulebase_18.gif" onclick="selectSignImage(this)"></td>
									<td width="66px" align="center"><img id="rulebase_19" name="selectImage" alt="" style="cursor: pointer;" src="avicit/platform6/centralcontrol/syscodingrule/images/rulebase_19.gif" onclick="selectSignImage(this)"></td>
									<td width="66px" align="center"><img id="rulebase_20" name="selectImage" alt="" style="cursor: pointer;" src="avicit/platform6/centralcontrol/syscodingrule/images/rulebase_20.gif" onclick="selectSignImage(this)"></td>
								</tr>
							</table>
						</td>
					</tr>
							...
							<table id="tableRuleSegment_${segment.segmentIndex}" width="700px" border="0">
								...
								<tr height="30px" id="tdCount_${segment.segmentIndex}" <c:if test="${segment.segmentType != '4'}">style="display: none"</c:if>>
									...
									<td id="tdFormatValue_${segment.segmentIndex}" <c:if test="${segment.segmentType == '4' && segment.classify == '1'}">style="display: none"</c:if>>
										<input id="format_${segment.segmentIndex}" name="format" class="easyui-combobox" data-options="editable:false,panelHeight: 100,valueField:'code',textField:'name',url:'platform/cc/sysCodingRule/getCountFormatDate.json'" style="width: 202px" value="${segment.format}"/>
									</td>
								</tr>
