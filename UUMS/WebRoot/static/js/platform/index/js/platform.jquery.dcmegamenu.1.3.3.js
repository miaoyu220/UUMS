	...
	$.fn.dcMegaMenu = function(options,resizeFlag){
		...
		return $dcMegaMenuObj.each(function(options){
			...
			function megaOver(){
				...
				if(positonLeft+subDivWidth+num>browserWidth){
					beforeOpenEvent(subNav.parent(),browserWidth-subDivWidth-num);
				}else if(positonLeft+num < 0){
					beforeOpenEvent(subNav.parent(), 0 - num);
				}else{
