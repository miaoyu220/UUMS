...
function loadSelectTabInfo(title){
	...
	if(title=="部门基本信息"){
		...
		if(currTreeNode){
			...
			if(oldUrl==""){
				var newUrl=path+"/avicit/platform6/centralcontrol/sysdept/sysuserList.jsp?id="+currTreeNode.id+"&type="+currTreeNode.attributes.type+"&name="+currTreeNode.text;
		...
		<div id="tabDept" iconCls="icon-dept" title="部门基本信息" class="panel-noscroll">
			...
			<form id="deptEditForm" name="deptEditForm" method="post">
				...
				<div class="formExtendBase">
					<sec:accesscontrollist hasPermission="3" domainObject="ccsysdept_form_DEPT_CODE" permissionDes="部门代码">
					...
					<sec:accesscontrollist hasPermission="3" domainObject="ccsysdept_form_DEPT_NAME" permissionDes="部门名称">
						<div class="formUnit column2">
					...
					<sec:accesscontrollist hasPermission="3" domainObject="ccsysdept_form__DEPT_ALIAS"  permissionDes="部门别名">
						<div class="formUnit column2">
							<label>部门别名：</label>
							<div class="inputContainer">
					...
					<sec:accesscontrollist hasPermission="3" domainObject="ccsysdept_form_PARENT_DEPT_NAME"  permissionDes="上级部门">
						<div class="formUnit column2">
							<label>上级部门：</label>
							<div class="inputContainer">
					...
					<sec:accesscontrollist hasPermission="3" domainObject="ccsysdept_form_POST" permissionDes="邮编">
						<div class="formUnit column2">
							<label>邮编：</label>
							<div class="inputContainer">
					...
					<sec:accesscontrollist hasPermission="3" domainObject="ccsysdept_form_TEL" permissionDes="电话">
						<div class="formUnit column2">
							<label >电话：</label>
							<div class="inputContainer">
					...
					<sec:accesscontrollist hasPermission="3" domainObject="ccsysdept_form_FAX" permissionDes="传真">
						<div class="formUnit column2">
							<label >传真：</label>
							<div class="inputContainer">
					...
					<sec:accesscontrollist hasPermission="3" domainObject="ccsysdept_form_EMAIL" permissionDes="邮件">
						<div class="formUnit column2">
							<label >邮件：</label>
							<div class="inputContainer">
					...
					<sec:accesscontrollist hasPermission="3" domainObject="ccsysdept_form_WORK_CALENDAR_ID" permissionDes="工作日历">
						<div class="formUnit column2">
							<label>工作日历：</label>
							<div class="inputContainer">
					...
					<sec:accesscontrollist hasPermission="3" domainObject="ccsysdept_form_ORDER_BY" permissionDes="排序编号">
						<div class="formUnit column2">
							<label>排序编号：</label>
							<div class="inputContainer">
					...
					<sec:accesscontrollist hasPermission="3" domainObject="ccsysdept_form_DEPT_PLACE" permissionDes="工作地点">
						<div class="formUnit column2">
							<label>工作地点：</label>
							<div class="inputContainer">
					...
					<sec:accesscontrollist hasPermission="3" domainObject="ccsysdept_form_DEPT_TYPE" permissionDes="部门类型">
						<div class="formUnit column2">
					...
					<sec:accesscontrollist hasPermission="3" domainObject="ccsysdept_form_VALID_FLAG" permissionDes="状态">
						<div class="formUnit column2">
					...
					<sec:accesscontrollist hasPermission="3" domainObject="ccsysdept_form_DEPT_DESC" permissionDes="描述">
