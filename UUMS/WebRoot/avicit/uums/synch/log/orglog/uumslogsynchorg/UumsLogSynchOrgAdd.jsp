...
<!-- ControllerPath = "uums/synch/log/orglog/uumslogsynchorg/UumsLogSynchOrgController/operation/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
					...
					<tr>
								...
								<td>
															...
															<th align="right">
																...
																组织名称:</th>
								<td>
																											<input title="组织名称" class="easyui-validatebox" data-options="required:true,validType:'maxLength[200]'" style="width: 180px;" type="text" name="orgName" id="orgName"/>
																									</td>								
																	</tr>
									<tr>
															...
															<th align="right">
																...
																组织编码:</th>
								<td>
																											<input title="组织编码" class="easyui-validatebox" data-options="required:true,validType:'maxLength[100]'" style="width: 180px;" type="text" name="orgCode" id="orgCode"/>
																									</td>								
	...
	function closeForm(){
		parent.uumsLogSynchOrg.closeDialog("#insert");
	}
	function saveForm(){
	    if ($('#form').form('validate') == false) {
            return;
        }
		parent.uumsLogSynchOrg.save(serializeObject($('#form')),"#insert");
	}
	</script>
</body>
</html>