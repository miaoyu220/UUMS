...
<form id="formRuleSegment_${param.index}" method="post" enctype="multipart/form-data">
	<table id="tableRuleSegment_${param.index}" width="700px" border="0">
		...
		<tr height="30px" id="tdCount_${param.index}" style="display: none">
			...
			<td>
				<input id="classify_${param.index}" name="classify" class="easyui-combobox" data-options="editable:false,panelHeight:'auto',onChange: function(newValue,oldValue){doChangeClassify(${param.index},newValue,oldValue)},valueField:'code',textField:'name',url:'platform/sysCodingRuleController/getCountType.json'" style="width: 202px"/>
			</td>
			<td align="right" id="tdFormatName_${param.index}">格式化</td>
			<td id="tdFormatValue_${param.index}">
				<input id="format_${param.index}" name="format" class="easyui-combobox" data-options="editable:false,panelHeight: 100,valueField:'code',textField:'name',url:'platform/sysCodingRuleController/getCountFormatDate.json'" style="width: 202px"/>
			</td>
		</tr>
