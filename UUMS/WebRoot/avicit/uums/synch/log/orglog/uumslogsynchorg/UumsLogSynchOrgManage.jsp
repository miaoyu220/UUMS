...
<!-- ControllerPath = "uums/synch/log/orglog/uumslogsynchorg/UumsLogSynchOrgController/UumsLogSynchOrgInfo" -->
<title></title>
			...
			<table>
				<tr>
					<%-- <sec:accesscontrollist hasPermission="3"
						domainObject="formdialog_uumsLogSynchOrg_button_add"
						permissionDes="添加">
						<td><a class="easyui-linkbutton" iconCls="icon-add"
							plain="true" onclick="uumsLogSynchOrg.insert();"
							href="javascript:void(0);">添加</a></td>
					</sec:accesscontrollist>
					<sec:accesscontrollist hasPermission="3"
						domainObject="formdialog_uumsLogSynchOrg_button_edit"
						permissionDes="编辑">
						<td><a class="easyui-linkbutton" iconCls="icon-edit"
							plain="true" onclick="uumsLogSynchOrg.modify();"
	...
	<script type="text/javascript">
		...
		$(function() {
			uumsLogSynchOrg = new UumsLogSynchOrg('dgUumsLogSynchOrg',
					'${url}', 'searchDialog', 'uumsLogSynchOrg',true);
		});
		...
		//uumsLogSynchOrg.detail(\''+row.id+'\')
		function formateHref(value, row, inde) {
			return '<a href="javascript:void(0);" onclick="uumsLogSynchOrg.detail(\''
					+ row.id + '\');">' + value + '</a>';
		}
