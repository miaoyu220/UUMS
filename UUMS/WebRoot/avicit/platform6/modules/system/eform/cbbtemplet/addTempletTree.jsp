					...
					<tr>
						...
						<td><span style="padding:0px;margin: 0px;">
								<span style="padding:0px;margin: 0px;width: 5px;display: inline-block;">
							  	...
							  	<input title="模版编号" class="inputbox" style="width: 180px;" type="text" name="tempCode" id="tempCode"/>
							</span></td>
					...
					<tr>
						...
						<td>
							<span style="padding:0px;margin: 0px;">
								...
								<input title="系统代码类型名称" class="inputbox" style="width: 180px;" type="text" name="tempName" id="tempName"/></span>
						</td>
					</tr>
					<tr>
						<th align="right">描述:</th>
						<td colspan="3"><div style="padding-left: 10px;"><input title="描述" class="inputbox" style="width: 92%;" type="text" name="remark" id="remark"/></div></td>
					</tr>
				</table>
		</form>
