...
function showAddUser()
{
	...
	var usd = new CommonDialog("userAddDialog","800","500",path+"avicit/platform6/centralcontrol/sysgroup/addUser.jsp?groupId="+groupId,"添加用户");
	var buttons = [{
		text:'添加',
		id : 'formSubimt',
		//iconCls : 'icon-submit',
		handler:function(){
			 ...
			 $.ajax({
		        cache: true,
		        type: "POST",
		        url:'platform/cc/sysgroup/saveUserGroup.json',
		        dataType:"json",
