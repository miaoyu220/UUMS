...
<!-- ControllerPath = "uums/appsys/synchconfig/uumssynchtypeconfig/UumsSynchTypeConfigController/operation/sub/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false"
		...
		<form id='form'>
			<input type="hidden" name="id" /> <input type="hidden" name="typeId"
				id="typeId" value='${pid}' />
			<table width="100%" style="padding-top: 10px;">
				...
				<tr>
					...
					<td><input title="字段CODE" class="easyui-validatebox"
						...
						id="columnCode" /></td>
					<th align="right"><span style="color: red;">*</span> 数据类型:</th>
					<td><pt6:syslookup name="dataType"
							lookupCode="UUMS_DB_DATA_TYPE"
				...
				<tr>
					...
					<td><input title="字段数据格式化" class="inputbox easyui-validatebox"
						data-options="validType:'maxLength[200]'" style="width: 180px;"
						type="text" name="uumsAttribute" id="uumsAttribute" /></td>
					<th align="right">字段数据格式化:</th>
					<td><input title="字段数据格式化" class="inputbox easyui-validatebox"
						data-options="validType:'maxLength[200]'" style="width: 180px;"
						type="text" name="dataFormat" id="dataFormat" /></td>
				</tr>
			</table>
		</form>
	...
	<script type="text/javascript">
		...
		function closeForm() {
			parent.uumsSynchOrgUserMapper.closeDialog("#insert");
		}
		function saveForm() {
			if ($('#form').form('validate') == false) {
				return;
			}
			parent.uumsSynchOrgUserMapper.save(serializeObject($('#form')),
					"#insert");
		}
	</script>
</body>
