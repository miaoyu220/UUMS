		...
		<div class="formExtendBase">
			...
			<div class="formUnit column1">
				...
				<div class="inputContainer">
					<input style="width:400px;" id="systemFlag" name="systemFlag" title="系统级别" class="easyui-combobox" required="true"
			...
			<div class="formUnit column1">
				...
				<div class="inputContainer">
					<input style="width:400px;" id="validFlag" name="validFlag" title="有效标识" class="easyui-combobox" required="true"
					    data-options="editable:false,panelHeight:'auto',valueField:'code',textField:'name',
			...
			<div class="formUnit column1">
				...
				<div class="inputContainer input-readonly">
					<input style="width:400px;" id="sysLanguageCode" name="sysLanguageCode" title="有效标识" class="easyui-combobox" readonly="readonly" required="true"
					    data-options="editable:false,panelHeight:'auto',valueField:'code',textField:'name',
